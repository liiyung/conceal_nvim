...
syn match mkdEscapeChar "\\mathcal{M}" conceal cchar=ℳ
...
syn match mkdEscapeChar "\\mathcal{R}" conceal cchar=ℛ
...
syn match mkdEscapeChar "\\vdots" conceal cchar=⋮
syn match mkdEscapeChar "\\ddots" conceal cchar=⋱
syn match mkdEscapeChar "\\nabla" conceal cchar=∇
...
syn match mkdEscapeChar "\\sqrt" conceal cchar=√
